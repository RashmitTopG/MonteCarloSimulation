...
@app.callback(
    [
        Output('simulation-results', 'children'),                    # 1
        Output('simulation-graph', 'figure'),                      # 2
        Output('revenue-description', 'children'),                 # 3
        Output('lead-time-risk-graph', 'figure'),                  # 4
        Output('lead-time-description', 'children'),               # 5
        Output('defect-rate-risk-graph', 'figure'),                # 6
        Output('defect-rate-description', 'children'),             # 7
        Output('shipping-cost-risk-graph', 'figure'),              # 8
        Output('shipping-cost-description', 'children'),            # 9
        Output('manufacturing-cost-risk-graph', 'figure'),         # 10
        Output('manufacturing-cost-description', 'children'),      # 11
        Output('box-plot-graph', 'figure'),                        # 12
        Output('box-plot-description', 'children'),                # 13
        Output('cdf-plot-graph', 'figure'),                        # 14
        Output('cdf-description', 'children'),                     # 15
        Output('bar-chart-graph', 'figure'),                       # 16
        Output('bar-chart-description', 'children'),               # 17
        Output('defect-rate-histogram', 'figure'),                 # 18
        Output('defect-rate-histogram-description', 'children'),    # 19
        Output('pie-chart-risk-factors', 'figure'),                # 20
        Output('pie-chart-description', 'children'),               # 21
        Output('major-risk-factor-bar-chart', 'figure'),           # 22
        Output('major-risk-factor-description', 'children')        # 23
    ],
...
def update_simulation(num_simulations):
    ...
    # Pie Chart of Risk Factors (Donut Chart with Enhanced UI)
    ...
    return [
    simulation_results_text,                # 1
    fig_revenue,                           # 2
    revenue_description,                   # 3
    fig_lead_time,                         # 4
    lead_time_description,                 # 5
    fig_defect_rate,                       # 6
    defect_rate_description,               # 7
    fig_shipping_cost,                     # 8
    shipping_cost_description,             # 9
    fig_manufacturing_cost,                # 10
    manufacturing_cost_description,        # 11
    fig_box_plot,                          # 12
    box_plot_description,                  # 13
    fig_cdf,                               # 14
    cdf_description,                       # 15
    fig_bar_chart,                         # 16
    bar_chart_description,                 # 17
    fig_defect_rate_hist,                  # 18
    defect_rate_histogram_description,     # 19
    fig_pie_risk_factors,                  # 20
    pie_chart_description,                 # 21
    fig_major_risk,                        # 22
    major_risk_factor_description          # 23
]
